...
void TestAddition1()
{
  ...
  CS170::List list3;
  //std::cout << "List Count: " << CS170::List::list_count() << std::endl;
  list3 = list1 + list2;
  //std::cout << "List Count: " << CS170::List::list_count() << std::endl;
...
int main()
{
  try {
    ...
    std::cout << "***TestPushFront revealed something bad in the List class" << 
    std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestPushBack revealed something bad in the List class" << 
    std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestPushFrontBack revealed something bad in the List class"
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestPopFront revealed something bad in the List class" << 
    std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestArray1 revealed something bad in the List class" << 
    std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestArray2 revealed something bad in the List class" << 
    std::endl;
  }
  ...
  try {
    ...
    std::cout << 
    "***TestCopyConstructor1 revealed something bad in the List class" << 
    std::endl;
  }
  ...
  try {
    ...
    std::cout <<
     "***TestCopyConstructor2 revealed something bad in the List class" <<
     std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAssignment1 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAssignment2 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAddAssign1 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAddAssign2 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAddAssign3 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAddAssign4 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestSubscript1 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestSubscript2 revealed something bad in the List class"
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAddition1 revealed something bad in the List class" 
    << std::endl;
  }
  ...
  try {
    ...
    std::cout << "***TestAddition2 revealed something bad in the List class" 
    << std::endl;
  }
