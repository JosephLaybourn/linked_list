  ...
  switch (test)
  {
    case 1:
      try {
        ...
        std::cout << 
        "***TestStress1 revealed something bad in the List class" << std::endl;
      }
      break;
    ...
    case 2:
      try {
        ...
        std::cout << 
        "***TestStress2 revealed something bad in the List class" << std::endl;
      }
      break;
    ...
    case 3:
      try {
        ...
        std::cout << 
        "***TestStress3 revealed something bad in the List class" << std::endl;
      }
      break;
    ...
    case 4:
      try {
        ...
        std::cout << 
        "***TestStress4 revealed something bad in the List class" << std::endl;
      }
      break;
    ...
    case 5:
      try {
        ...
        std::cout << 
        "***TestStress5 revealed something bad in the List class" << std::endl;
      }
      break;
